...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://okatsn.github.io/OkInformationalAnalysis.jl/stable/)
[![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://okatsn.github.io/OkInformationalAnalysis.jl/dev/)
[![Build Status](https://github.com/okatsn/OkInformationalAnalysis.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/okatsn/OkInformationalAnalysis.jl/actions/workflows/CI.yml?query=branch%3Amain)
[![Coverage](https://codecov.io/gh/okatsn/OkInformationalAnalysis.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/okatsn/OkInformationalAnalysis.jl)

<!-- Don't have any of your custom contents above; they won't occur if there is no citation. -->

## Documentation Badge is here:

[![](https://img.shields.io/badge/docs-stable-blue.svg)](https://okatsn.github.io/OkInformationalAnalysis.jl/stable)
[![](https://img.shields.io/badge/docs-dev-blue.svg)](https://okatsn.github.io/OkInformationalAnalysis.jl/dev)
...
- You have to add `ACCESS_OKREGISTRY` to the secret under the remote repo (e.g., https://github.com/okatsn/OkInformationalAnalysis.jl).
...
1. Switch to the local directory of this project (OkInformationalAnalysis)
2. Add an empty repo OkInformationalAnalysis(.jl) on github (without anything!)
...
This package is create on 2025-04-21.
